...
using TownOfWeekend.CrewmateRoles.MediumMod;
...
public static class CustomGameOptions
{
    ...
    public static HaunterCanBeClickedBy HaunterCanBeClickedBy =>
        (HaunterCanBeClickedBy)Generate.HaunterCanBeClickedBy.Get();
    ...
    public static float RadiateRange => Generate.RadiateRange.Get();
    public static float RadiateCooldown => Generate.RadiateCooldown.Get();
    public static float RadiateInvis => Generate.RadiateInvis.Get();
    ...
    public static float RandomMapSubmerged =>
        SubmergedCompatibility.Loaded ? Generate.RandomMapSubmerged.Get() : 0f;
