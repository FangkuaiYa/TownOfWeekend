...
internal class RandomMap
{
    ...
    public static void Postfix(AmongUsClient __instance)
    {
        if (__instance.AmHost)
        {
            ...
            {
                if (CustomGameOptions.SmallMapHalfVision && vision != 0)
    ...
    public static void AdjustSettings(byte map)
    {
        if (map <= 1)
        {
            ...
            GameOptionsManager.Instance.currentNormalGameOptions.NumShortTasks +=
                CustomGameOptions.SmallMapIncreasedShortTasks;
            GameOptionsManager.Instance.currentNormalGameOptions.NumLongTasks +=
                CustomGameOptions.SmallMapIncreasedLongTasks;
        }
        ...
        {
            GameOptionsManager.Instance.currentNormalGameOptions.NumShortTasks -=
                CustomGameOptions.LargeMapDecreasedShortTasks;
            GameOptionsManager.Instance.currentNormalGameOptions.NumLongTasks -=
                CustomGameOptions.LargeMapDecreasedLongTasks;
            AdjustCooldowns(CustomGameOptions.LargeMapIncreasedCooldown);
        }
    }
