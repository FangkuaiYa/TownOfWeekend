...
namespace TownOfWeekend.ImpostorRoles.BomberMod;

[HarmonyPatch(typeof(KillButton), nameof(KillButton.DoClick))]
public class Plant
{
    public static Sprite PlantSprite => ResourcesManager.PlantSprite;
    public static Sprite DetonateSprite => ResourcesManager.DetonateSprite;
