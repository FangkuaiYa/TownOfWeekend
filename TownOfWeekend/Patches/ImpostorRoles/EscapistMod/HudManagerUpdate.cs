...
namespace TownOfWeekend.ImpostorRoles.EscapistMod;

[HarmonyPatch(typeof(HudManager), nameof(HudManager.Update))]
public class HudManagerUpdate
{
    public static Sprite MarkSprite => ResourcesManager.MarkSprite;
    public static Sprite EscapeSprite => ResourcesManager.EscapeSprite;
    ...
    public static void Postfix(HudManager __instance)
    {
        ...
        role.EscapeButton.gameObject.SetActive(
