...
{
    public static Sprite Blackmail => ResourcesManager.BlackmailSprite;
    ...
    public static void Postfix(HudManager __instance)
    {
        ...
        role.BlackmailButton.gameObject.SetActive(
        ...
        Utils.SetTarget(ref role.ClosestPlayer, role.BlackmailButton,
