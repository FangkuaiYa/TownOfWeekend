...
namespace TownOfWeekend.ImpostorRoles.VenererMod;

[HarmonyPatch(typeof(HudManager), nameof(HudManager.Update))]
public class HudManagerUpdate
{
    public static Sprite NoneSprite => ResourcesManager.NoAbilitySprite;
    public static Sprite CamoSprite => ResourcesManager.CamouflageSprite;
    public static Sprite CamoSprintSprite => ResourcesManager.CamoSprintSprite;
    public static Sprite CamoSprintFreezeSprite => ResourcesManager.CamoSprintFreezeSprite;
    ...
    public static void Postfix(HudManager __instance)
    {
        ...
        role.AbilityButton.gameObject.SetActive(
