...
namespace TownOfWeekend.ImpostorRoles.UndertakerMod;
...
public class PlayerControlUpdate
{
    public static void Postfix(HudManager __instance)
    {
        ...
        if (role.DragDropButton == null)
        {
            ...
            role.DragDropButton.graphic.sprite = ResourcesManager.DragSprite;
            role.DragDropButton.gameObject.SetActive(false);
        }

        if (role.DragDropButton.graphic.sprite != ResourcesManager.DragSprite &&
            role.DragDropButton.graphic.sprite != ResourcesManager.DropSprite)
            role.DragDropButton.graphic.sprite = ResourcesManager.DragSprite;

        if (role.DragDropButton.graphic.sprite == ResourcesManager.DropSprite && role.CurrentlyDragging == null)
            role.DragDropButton.graphic.sprite = ResourcesManager.DragSprite;

        role.DragDropButton.gameObject.SetActive(
