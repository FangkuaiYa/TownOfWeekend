...
namespace TownOfWeekend.ImpostorRoles.WarlockMod;
...
public class HudManagerUpdate
{
    public static void Postfix(HudManager __instance)
    {
        ...
        {
            role.ChargeText = Object.Instantiate(__instance.KillButton.cooldownTimerText,
                __instance.KillButton.transform);
            ...
            role.ChargeText.alignment = TextAlignmentOptions.Right;
            role.ChargeText.fontStyle = FontStyles.Bold;
            role.ChargeText.enableWordWrapping = false;
        }

        if (role.ChargeText != null) role.ChargeText.text = role.ChargePercent + "%";
        role.ChargeText.gameObject.SetActive(
