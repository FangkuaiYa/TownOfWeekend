...
namespace TownOfWeekend.ImpostorRoles.MorphlingMod;

[HarmonyPatch(typeof(HudManager), nameof(HudManager.Update))]
public class HudManagerUpdate
{
    public static Sprite SampleSprite => ResourcesManager.SampleSprite;
    public static Sprite MorphSprite => ResourcesManager.MorphSprite;
    ...
    public static void Postfix(HudManager __instance)
    {
        ...
        role.MorphButton.gameObject.SetActive(
