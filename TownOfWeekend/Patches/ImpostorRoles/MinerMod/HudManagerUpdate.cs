...
namespace TownOfWeekend.ImpostorRoles.MinerMod;

[HarmonyPatch(typeof(HudManager), nameof(HudManager.Update))]
public class HudManagerUpdate
{
    public static Sprite MineSprite => ResourcesManager.MineSprite;
    ...
    public static void Postfix(HudManager __instance)
    {
        ...
        role.MineButton.gameObject.SetActive(
        ...
        hits = hits.ToArray().Where(c =>
            ...
            .ToArray();
        if (hits.Count == 0 && PlayerControl.LocalPlayer.moveable)
        {
