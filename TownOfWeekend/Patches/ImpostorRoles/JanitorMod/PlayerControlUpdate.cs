...
namespace TownOfWeekend.ImpostorRoles.JanitorMod;
...
public class PlayerControlUpdate
{
    public static void Postfix(HudManager __instance)
    {
        ...
        role.CleanButton.SetCoolDown(PlayerControl.LocalPlayer.killTimer,
