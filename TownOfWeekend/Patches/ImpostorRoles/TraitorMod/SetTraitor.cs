...
using TownOfWeekend.CrewmateRoles.SnitchMod;
...
namespace TownOfWeekend.ImpostorRoles.TraitorMod;
...
public static class AirshipExileController_WrapUpAndSpawn
{
    ...
    {
        SetTraitor.ExileControllerPostfix(__instance);
    }
}
    ...
    public static void ExileControllerPostfix(ExileController __instance)
    {
        ...
        foreach (var player in alives)
            if (player.Data.IsImpostor() ||
                (player.Is(Faction.NeutralKilling) && CustomGameOptions.NeutralKillingStopsTraitor))
                return;
