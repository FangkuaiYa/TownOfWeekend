...
public static class AirshipExileController_WrapUpAndSpawn
{
    ...
    {
        SetHaunter.ExileControllerPostfix(__instance);
    }
}
...
public class SetHaunter
{
    ...
    public static void ExileControllerPostfix(ExileController __instance)
    {
        ...
        WillBeHaunter.gameObject.GetComponent<PassiveButton>().OnClick = new Button.ButtonClickedEvent();
        WillBeHaunter.gameObject.GetComponent<PassiveButton>().OnClick
            .AddListener((Action)(() => WillBeHaunter.OnClick()));
