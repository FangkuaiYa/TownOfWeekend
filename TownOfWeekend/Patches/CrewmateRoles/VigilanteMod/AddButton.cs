...
namespace TownOfWeekend.CrewmateRoles.VigilanteMod;
...
public class AddButton
{
    ...
    private static Action Guess(Vigilante role, PlayerVoteArea voteArea)
    {
        void Listener()
        {
            ...
            if (playerModifier != null)
                toDie = playerRole.Name == currentGuess || playerModifier.Name == currentGuess
                    ? playerRole.Player
                    : role.Player;
    ...
    public static void Postfix(MeetingHud __instance)
    {
        ...
        foreach (var voteArea in __instance.playerStates) GenButton(retributionistRole, voteArea);
    }
}