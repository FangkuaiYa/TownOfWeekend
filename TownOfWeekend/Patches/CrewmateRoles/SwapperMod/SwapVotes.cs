...
namespace TownOfWeekend.CrewmateRoles.SwapperMod;
...
public class SwapVotes
{
    ...
    public static class VotingComplete
    {
        ...
        {
            PluginSingleton<TownOfWeekendPlugin>.Instance.Log.LogMessage(Swap1 == null ? "null" : Swap1.ToString());
            PluginSingleton<TownOfWeekendPlugin>.Instance.Log.LogMessage(Swap2 == null ? "null" : Swap2.ToString());
            ...
            for (var childI = 0; childI < Swap1.transform.childCount; childI++)
                if (Swap1.transform.GetChild(childI).gameObject.name == "playerVote(Clone)")
                    votes1.Add(Swap1.transform.GetChild(childI));
            ...
            for (var childI = 0; childI < Swap1.transform.childCount; childI++)
                if (Swap1.transform.GetChild(childI).gameObject.name == "playerVote(Clone)")
                    votes2.Add(Swap1.transform.GetChild(childI));
