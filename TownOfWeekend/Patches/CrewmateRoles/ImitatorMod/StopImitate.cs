    ...
    public static void Prefix(PlayerControl __instance, [HarmonyArgument(0)] NetworkedPlayerInfo meetingTarget)
    {
        ...
        if (StartImitate.ImitatingPlayer != null && !StartImitate.ImitatingPlayer.Is(RoleEnum.Traitor))
        {
            ...
            if (PlayerControl.LocalPlayer == StartImitate.ImitatingPlayer)
            {
                ...
                if (!PlayerControl.LocalPlayer.Is(RoleEnum.Investigator) && !PlayerControl.LocalPlayer.Is(
                                                                             RoleEnum.Mystic)
                                                                         && !PlayerControl.LocalPlayer.Is(RoleEnum.Spy))
            ...
            var killsList = (role.Kills, role.CorrectKills, role.IncorrectKills, role.CorrectAssassinKills,
