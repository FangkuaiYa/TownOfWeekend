...
namespace TownOfWeekend.CrewmateRoles.ImitatorMod;

[HarmonyPatch(typeof(MeetingHud), nameof(MeetingHud.Start))]
public class AddButtonImitator
{
    private static int _mostRecentId;
    private static Sprite ActiveSprite => ResourcesManager.ImitateSelectSprite;
    public static Sprite DisabledSprite => ResourcesManager.ImitateDeselectSprite;
            ...
            foreach (var player in PlayerControl.AllPlayerControls)
                if (player.PlayerId == __instance.playerStates[i].TargetPlayerId)
                {
                    ...
                    if (player.Data.IsDead && !player.Data.Disconnected && (imitatedRole == RoleEnum.Detective ||
                                                                            ...
                                                                            imitatedRole == RoleEnum.Spy ||
                                                                            imitatedRole == RoleEnum.Tracker ||
                                                                            imitatedRole == RoleEnum.Sheriff ||
                                                                            imitatedRole == RoleEnum.Veteran ||
                                                                            imitatedRole == RoleEnum.Altruist ||
                                                                            ...
                                                                            imitatedRole == RoleEnum.VampireHunter ||
                                                                            imitatedRole == RoleEnum.Aurial ||
                                                                            imitatedRole == RoleEnum.Oracle))
                        imitatable = true;
