...
namespace TownOfWeekend.CrewmateRoles.MedicMod;

[HarmonyPatch(typeof(MeetingHud), nameof(MeetingHud.Start))]
public class AddButton
{
    private static Sprite LighterSprite => ResourcesManager.LighterSprite;
    public static Sprite DarkerSprite => ResourcesManager.DarkerSprite;
    ...
    public static void GenButton(Medic role, PlayerVoteArea voteArea)
    {
        ...
        var playerControl = PlayerControl.AllPlayerControls.ToArray()
            .FirstOrDefault(p => p.PlayerId == voteArea.TargetPlayerId);
