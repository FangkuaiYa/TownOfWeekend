...
namespace TownOfWeekend.Modifiers.DisperserMod;

[HarmonyPatch(typeof(HudManager), nameof(HudManager.Update))]
public class Update
{
    public static Sprite DisperseButton => ResourcesManager.DisperseSprite;
    ...
    private static void UpdateButtonButton(HudManager __instance)
    {
        ...
        role.DisperseButton.gameObject.SetActive(
