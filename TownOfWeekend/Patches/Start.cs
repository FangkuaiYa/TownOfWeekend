...
public static class Start
{
    ...
    public static void Postfix(IntroCutscene._CoBegin_d__35 __instance)
    {
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Detective))
        {
            ...
            detective.LastExamined =
                detective.LastExamined.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.ExamineCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Medium))
        {
            ...
            medium.LastMediated =
                medium.LastMediated.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.MediateCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Seer))
        {
            ...
            seer.LastInvestigated =
                seer.LastInvestigated.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.SeerCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Oracle))
        {
            ...
            oracle.LastConfessed =
                oracle.LastConfessed.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.ConfessCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Aurial))
        {
            ...
            aurial.LastRadiated =
                aurial.LastRadiated.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.RadiateCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Sheriff))
        {
            ...
            sheriff.LastKilled =
                sheriff.LastKilled.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.SheriffKillCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Tracker))
        {
            ...
            tracker.LastTracked =
                tracker.LastTracked.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.TrackCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Transporter))
        {
            ...
            transporter.LastTransported =
                transporter.LastTransported.AddSeconds(CustomGameOptions.InitialCooldowns -
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Trapper))
        {
            ...
            trapper.LastTrapped =
                trapper.LastTrapped.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.TrapCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Veteran))
        {
            ...
            veteran.LastAlerted =
                veteran.LastAlerted.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.AlertCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Chameleon))
        {
            ...
            chameleon.LastSwooped =
                chameleon.LastSwooped.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.SwoopCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Necromancer))
        {
            ...
            necro.LastRevived =
                necro.LastRevived.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.ReviveCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Whisperer))
        {
            ...
            whisperer.LastWhispered =
                whisperer.LastWhispered.AddSeconds(CustomGameOptions.InitialCooldowns -
                                                   CustomGameOptions.WhisperCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Blackmailer))
        {
            ...
            blackmailer.LastBlackmailed =
                blackmailer.LastBlackmailed.AddSeconds(CustomGameOptions.InitialCooldowns -
                                                       CustomGameOptions.BlackmailCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Escapist))
        {
            ...
            escapist.LastEscape =
                escapist.LastEscape.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.EscapeCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Grenadier))
        {
            ...
            grenadier.LastFlashed =
                grenadier.LastFlashed.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.GrenadeCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Morphling))
        {
            ...
            morphling.LastMorphed =
                morphling.LastMorphed.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.MorphlingCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Swooper))
        {
            ...
            swooper.LastSwooped =
                swooper.LastSwooped.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.SwoopCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Venerer))
        {
            ...
            venerer.LastCamouflaged =
                venerer.LastCamouflaged.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.AbilityCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Undertaker))
        {
            ...
            undertaker.LastDragged =
                undertaker.LastDragged.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.DragCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Arsonist))
        {
            ...
            arsonist.LastDoused =
                arsonist.LastDoused.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.DouseCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Doomsayer))
        {
            ...
            doomsayer.LastObserved =
                doomsayer.LastObserved.AddSeconds(
                    CustomGameOptions.InitialCooldowns - CustomGameOptions.ObserveCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Executioner))
        {
            ...
            if (exe.target == null)
            {
                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                    (byte)CustomRPC.ExecutionerToJester, SendOption.Reliable);
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Glitch))
        {
            ...
            glitch.LastKill =
                glitch.LastKill.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.GlitchKillCooldown);
            glitch.LastHack =
                glitch.LastHack.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.HackCooldown);
            glitch.LastMimic =
                glitch.LastMimic.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.MimicCooldown);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.GuardianAngel))
        {
            ...
            ga.LastProtected =
                ga.LastProtected.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.ProtectCd);
            if (ga.target == null)
            {
                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                    (byte)CustomRPC.GAToSurv, SendOption.Reliable);
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Juggernaut))
        {
            ...
            juggernaut.LastKill =
                juggernaut.LastKill.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.JuggKCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Plaguebearer))
        {
            ...
            plaguebearer.LastInfected =
                plaguebearer.LastInfected.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.InfectCd);
        }
        ...
        if (PlayerControl.LocalPlayer.Is(RoleEnum.Werewolf))
        {
            ...
            werewolf.LastRampaged =
                werewolf.LastRampaged.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.RampageCd);
            werewolf.LastKilled =
                werewolf.LastKilled.AddSeconds(CustomGameOptions.InitialCooldowns - CustomGameOptions.RampageKillCd);
        }
