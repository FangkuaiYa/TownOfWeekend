...
namespace TownOfWeekend.NeutralRoles.VampireMod;
...
public class Bite
{
    public static bool Prefix(KillButton __instance)
    {
        ...
        var aliveVamps = PlayerControl.AllPlayerControls.ToArray()
        ...
        if ((role.ClosestPlayer.Is(Faction.Crewmates) || (role.ClosestPlayer.Is(Faction.NeutralBenign)
                                                          && CustomGameOptions.CanBiteNeutralBenign) ||
             (role.ClosestPlayer.Is(Faction.NeutralEvil)
    ...
    public static void Convert(PlayerControl newVamp)
    {
        ...
        if (PlayerControl.LocalPlayer == newVamp)
        {
            ...
            if (PlayerControl.LocalPlayer.Is(RoleEnum.Survivor))
            {
                ...
                Object.Destroy(survRole.UsesText);
            }
