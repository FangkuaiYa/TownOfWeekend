...
{
    private static Sprite CycleBackSprite => ResourcesManager.CycleBackSprite;
    private static Sprite CycleForwardSprite => ResourcesManager.CycleForwardSprite;

    private static Sprite GuessSprite => ResourcesManager.GuessSprite;
    ...
    public static void GenButton(Doomsayer role, PlayerVoteArea voteArea)
    {
        ...
        cycleEventForward.AddListener(Cycle(role, voteArea, nameText));
    ...
    private static Action Cycle(Doomsayer role, PlayerVoteArea voteArea, TextMeshPro nameText,
        bool forwardsCycle = true)
    {
        void Listener()
        {
    ...
    public static void Postfix(MeetingHud __instance)
    {
        ...
        foreach (var voteArea in __instance.playerStates) GenButton(doomsayerRole, voteArea);
    }
}