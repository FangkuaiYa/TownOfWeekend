...
namespace TownOfWeekend.NeutralRoles.GuardianAngelMod;
...
{
    public static Color ProtectedColor = new(1f, 0.85f, 0f, 1f);
    ...
    public static void Postfix(HudManager __instance)
    {
        foreach (var role in Role.GetRoles(RoleEnum.GuardianAngel))
        {
            ...
            if (ga.Protecting)
            {
                ...
                else if (PlayerControl.LocalPlayer.PlayerId == player.PlayerId &&
                         (showProtected == ProtectOptions.Self ||
