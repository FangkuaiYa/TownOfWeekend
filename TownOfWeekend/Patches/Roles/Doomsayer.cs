        ...
        if (CustomGameOptions.GameMode == GameMode.Classic || CustomGameOptions.GameMode == GameMode.AllAny)
        {
            ...
            if (CustomGameOptions.DoomsayerGuessNeutralBenign)
            {
                if (CustomGameOptions.AmnesiacOn > 0 ||
                    ...
                    (CustomGameOptions.GuardianAngelOn > 0 &&
                     CustomGameOptions.GaOnTargetDeath == BecomeOptions.Amnesiac))
                ...
                if (CustomGameOptions.SurvivorOn > 0 ||
                    ...
                    (CustomGameOptions.GuardianAngelOn > 0 &&
                     CustomGameOptions.GaOnTargetDeath == BecomeOptions.Survivor))
            ...
            if (CustomGameOptions.DoomsayerGuessNeutralEvil)
            {
                ...
                if (CustomGameOptions.JesterOn > 0 ||
                    ...
                    (CustomGameOptions.GuardianAngelOn > 0 &&
                     CustomGameOptions.GaOnTargetDeath == BecomeOptions.Jester))
